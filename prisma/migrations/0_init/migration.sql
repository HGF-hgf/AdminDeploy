...
CREATE TABLE `Product` (
    ...
    INDEX `Product_authorId_idx`(`authorId`),
    INDEX `Product_publisherId_idx`(`publisherId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `OrderItem` (
    ...
    `orderQuantity` VARCHAR(191) NOT NULL,
...
CREATE TABLE `Author` (
    ...
    INDEX `Author_storeId_idx`(`storeId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Publisher` (
    ...
    INDEX `Publisher_storeId_idx`(`storeId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `Author` ADD CONSTRAINT `Author_storeId_fkey` FOREIGN KEY (`storeId`) REFERENCES `Store`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Publisher` ADD CONSTRAINT `Publisher_storeId_fkey` FOREIGN KEY (`storeId`) REFERENCES `Store`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
